...
export default function InsertionSortPage() {
	...
	const [isLearned, toggleLearned] = useLearnedState("insertion_sort");

	const { randomize } = useRandomArray();
	const randomizeArray = () => setInputArray(randomize().join(", "));

	const algorithm = registry.algorithms.get("insertion_sort");
	const relatedAlgorithms = algorithm ? getRelatedAlgorithms("insertion_sort") : [];
	const prerequisites = algorithm ? getPrerequisites("insertion_sort") : [];
